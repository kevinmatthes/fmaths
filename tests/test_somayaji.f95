...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      call ensure (abs (somayaji (  29) - pi) .le. 1.0e-05, failures)
      ...
      call ensure (abs (somayaji (  58) - pi) .le. 1.0e-06, failures)
      ...
      call ensure (abs (somayaji (  65) - pi) .le. 1.0e-06, failures)
      call ensure (abs (somayaji (  66) - pi) .le. 7.5e-07, failures)
      call ensure (abs (somayaji (  67) - pi) .le. 1.0e-06, failures)
